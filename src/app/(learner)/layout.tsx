...
/**
 * Learner shell:
 * - When in course learning mode (/learn/...), the global portal sidebar is hidden to give
 *   full screen focus to the course player and its curriculum navigation.
 * - In regular dashboard/catalog views, the persistent learner sidebar is displayed.
 */
export default function LearnerLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      {isLearningMode ? (
        /* Focused Full-Width Learning Mode (No global portal sidebar) */
        <main className="min-w-0 flex-1 w-full px-3 py-3 sm:px-6 lg:px-8">
          {isReady ? children : <PageSpinner label="Loading learning session..." />}
        </main>
      ) : (
        /* Regular Portal View with Persistent Learner Navigation Sidebar */
